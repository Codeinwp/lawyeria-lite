...
function lawyeria_lite_customizer( $wp_customize ) {
    ...
    */
    $wp_customize->add_section( 'lawyeria_lite_404_section' , array(
        ...
        array('sanitize_callback' => 'lawyeria_lite_sanitize_text', 'default' => sprintf(__( 'Oops, I screwed up and you discovered my fatal flaw. Well, we\'re not all perfect, but we try. Can you try this again or maybe visit our %s to start fresh. We\'ll do better next time.', 'lawyeria-lite' ), '<a title="themeIsle" href="'. home_url() .'">'.__( 'Home Page', 'lawyeria-lite').'</a>')));
